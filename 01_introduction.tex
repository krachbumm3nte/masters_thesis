...
network discussed in this thesis includes very simple multi-compartment models, the choice of model was strongly
influenced by the fact that segregated dendrites were considered at all.
