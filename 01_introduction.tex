...
$\frac{\delta E}{\delta \phi(u_i)}$ \todo{cleanup} requires a method of filtering the spiketrain which itself has no
derivative \phrasing{...} 
...
neurons. \todo{talk about multiplicity of possible neuron models?}
...
precise spike timing for its plasticity \todo{cite}. Thus, one might expect rate neuron approximations to underperform  
...
to rate neurons with similar plasticity rules \citep{Stapmanns2021} \todo{cite more}. 
...
and focus different learning mechanisms \todo{do some reading and expand this}.
...
found in brain areas responsible for comparable tasks \cite{whittington2019theories,Yamins2016}. \todo{talk about ideal observer?}
