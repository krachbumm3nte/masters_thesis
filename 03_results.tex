...
\begin{figure}[t]
    ...
    \caption{Different network types learn to predict self-generated activity in superficial layers. All networks were
        ...
        \eta^{up}=\eta^{down}=0$). For spiking neurons, stability was increased by setting $\psi=150$.\todo{redo figure
        with less smoothing and tighter yscale}}
    \label{fig-self-pred}
\end{figure}
...
observed in electrophysiological \citep{thomson2002synaptic}\footnote and in-vitro \citep{binzegger2004quantitative} analyses of
...
is capable of compensating for absent \todo{finish}
