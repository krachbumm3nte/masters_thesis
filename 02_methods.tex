...
they will be called each others \textbf{sister neurons} from here on.\todo{discuss whether this 1 to 1 style connection is plausible!}. Pyramidal neurons
...
dendritic error from here on error). \cite{urbanczik2014learning} show, that \todo{what?}
