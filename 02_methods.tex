...
voltage directly, much like a \todo{find biological equivalent}. To understand what purpose this connectivity serves,
...
where $\phi$ acts componentwise on $u$ and can be interpreted as a smoothed variant of ReLu \todo{cite} with scaling factors $\gamma$, $\beta$,
...
One of the key research questions motivating this thesis was, whether the proposed architecture would be able to
...
period $t_{ref}$. \todo{this reads like ass}
